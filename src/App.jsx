...
STRUCTURE OBLIGATOIRE DU DOSSIER JURIDIQUE COMPLET :

1. PAGE DE GARDE
2. SOMMAIRE
3. RÉSUMÉ EXÉCUTIF
4. EXPOSÉ DES FAITS
5. ANALYSE JURIDIQUE COMPLÈTE
            ...
            <>
              ...
              <div className="questionnaire">
                ...
                <div style={{
                  ...
                  <span><strong>Conseil :</strong> Avant de générer, pensez à copier vos réponses dans un fichier texte sur votre ordinateur. En cas de problème technique, vous pourrez les réutiliser sans tout ressaisir.</span>
                </div>
